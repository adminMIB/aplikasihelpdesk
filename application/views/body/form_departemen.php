...
<a href="#" style="text-decoration:none">Tambah Data Dept</a></div>
					...
					<div class="form-group">
						...
						<input class="form-control" name="nama_dept" placeholder="Nama Perusahaan" value="<?php echo $nama_departemen;?>" required>
					</div>
