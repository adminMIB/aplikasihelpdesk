		...
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Branch / Cabang</li>
			</ol>
		</div><!--/.row-->
...
<a href="#" style="text-decoration:none">Tambah Data Branch / Cabang</a></div>
					...
					<div class="form-group">
						<label>Nama Branch / Cabang</label>
						<input class="form-control" name="nama_bagian_dept" value="<?php echo $nama_bagian_dept;?>" placeholder="Nama Branch / Cabang" required>
					</div>
