...
<a href="" style="text-decoration:none">List Ticket  <a href="<?php echo base_url();?>list_ticket/pdflistticket_customer" class="btn btn-danger" target="_blank">Pdf</a></a></div>
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						        ...
						        <th data-field="iddf" data-sortable="true">Foto</th>
						        <th data-field="urgensi" data-sortable="true">Urgensi</th>
						        <th data-field="s" data-sortable="true">Summary</th>
						        <th data-field="iddd" data-sortable="true">Tanggal</th>
						        <th data-field="idddd" data-sortable="true">Project Klien</th>
						        <th data-field="iddddd" data-sortable="true">Nama Sub Problem</th>
						        <th data-field="idddddd" data-sortable="true">Status</th>
						        <th data-sortable="true">Feedback</th>
						    </tr>
                            </thead>
                            <tbody>
                           <?php $no = 0; foreach($datalist_ticket as $row) : $no++;?>
						     <tr>
						        ...
						        <?php }
							        ...
							        {
							        	if(!$row->is_read_by_admin)
							        	{
							    			echo "<br><span style='color:red'>belum dibaca</span>";
							        	}
							        }
						        ?>
						        ...
						        <td data-field="iddsf">
						        	<?php if(!empty($row->user_file)){
						        	?>
						        		<img src="<?php echo base_url('/assets/images/'.$row->user_file) ?>" style="width:100px">
						        	<?php
						        	} ?>
						        </td>
						         <td data-field="urgensi"><?php echo $row->jenis_urgensi;?></td>
						        <td data-field="s"><?php echo $row->problem_summary;?></td>
