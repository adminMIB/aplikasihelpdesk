				...
				<div class="panel panel-primary">
					...
					<div class="panel panel-danger">
						...
						<div class="panel-body">
							...
							<input class="form-control" type="file" name="user_file" placeholder="Upload" value="<?php echo $user_file;?>" required>
						    </div> -->
